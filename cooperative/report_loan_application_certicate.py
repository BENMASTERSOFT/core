...
def _loanApplicationCerticateHeader():
...
def _loanApplicationCerticateGetLogoTable(width, height):
	widthList = [
		width * 20 / 100,
		width * 56 / 100,
		width * 19 / 100,
	...
	res = Table([
		[leftImg,_loanApplicationCerticateTitleTable(widthList[1],height),cur_date]
		],
		widthList,
		height
		)
...
def _loanApplicationCerticateTitleTable(width,height):
	heightList = [
	height * 60 / 100,
	height * 30 / 100,
	height * 10 / 100,
	...
	res = Table([
		[_loanApplicationCerticatetitlePara()],
...
def _loanApplicationCerticatetitlePara():
	header_text=ReportHeader.objects.first()
